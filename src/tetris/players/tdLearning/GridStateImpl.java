 ...
 * Time: 11:18
 */
public class GridStateImpl implements IState, Cloneable {
     ...
     */
    public GridStateImpl(int xPos, int yPos){ // in (x,y) order
        x = xPos;
        y = yPos;
    }
     ...
     * @return a <code>boolean</code> value */
    public boolean equals(GridStateImpl state){
        return (this.x == state.x && this.y == state.y);
    }

    public void move(GridActionImpl act)
    {
