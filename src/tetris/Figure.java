...
public class Figure extends Object {
    ...
    public void saveState(){
        if(savedState== null)
             savedState= new Figure(1);
        savedState.xPos = xPos;
        savedState.yPos = yPos;
        savedState.orientation = orientation;
    }
    public void undo(){
        xPos = savedState.xPos;
        yPos = savedState.yPos;
    ...
    public void moveAllWayLeft() {
        ...
        // Find lowest position
        while (canMoveTo(x +1, yPos, orientation)) {
            x++;
        }
    ...
    public void rotateRandom() {
        setRotation((int) (Game.rnd.nextDouble() * 4.0) % maxOrientation);
    }
